...
GRACE_NODISCARD GRACE_API VkImageSubresourceRange EntireImageSubresourceRange(ImageAspect aspect);

GRACE_NODISCARD GRACE_API VkImageAspectFlags DetermineImageAspectFlagsFromFormat(VkFormat format);
...
GRACE_NODISCARD GRACE_API VkRenderingAttachmentInfo ColourAttachmentInfo(
    const Image& image, VkClearValue* clear, VkImageLayout imageLayout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL);

GRACE_NODISCARD GRACE_API VkRenderingAttachmentInfo
