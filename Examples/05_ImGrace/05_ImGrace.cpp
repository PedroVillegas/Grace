...
int main()
{
    ...
    GLFWwindow* pWindow = glfwCreateWindow(windowWidth, windowHeight, "Grace x ImGui", nullptr, nullptr);
    ...
    Grace::CommandPool* pCmdPool = pDevice->GetCommandPool(Grace::QueueFamily::Graphics, "Example05::pCmdPool");
    ...
    // If this backend flag is not set, rendering will be limited to 64K vertices per window
    ...
    while (!glfwWindowShouldClose(pWindow))
    {
        ...
        cmd.BeginDynamicRendering(Grace::DynamicRenderingDesc {
            .renderArea = Grace::Rect2D({
                .extent = {.width = windowWidth, .height = windowHeight},
                .offset = {.x = 0, .y = 0},
            }),
            .colorAttachments = {
                Grace::ColourAttachmentInfo(pDevice->Get<Grace::Image>(swapchainImg), nullptr),
            },
            .depthAttachments = {},
            .stencilAttachments = {},
            .flags = 0,
        ...
        imGrace.Draw(ImGui::GetDrawData(), cmd);
